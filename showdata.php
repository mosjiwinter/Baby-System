<?php 
  ...
  $sql = "SELECT b.ibeacon_name name, a.status status, a.location loc, a.datetime datetime
          ...
          WHERE  a.mac_address = b.mac_address AND a.location = 'node1'
          AND a.datetime IN ( SELECT max(datetime) FROM   history GROUP BY mac_address)
          GROUP BY a.mac_address
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?php echo $l_homepage; ?>">Home</a>
        </li>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="<?php echo $l_myhome; ?>">My Home</a></li>
                       ...
                       <li><a class="dropdown-item" href="<?php echo $l_class; ?>">Class Room</a></li>
                                   <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="<?php echo $l_car; ?>">Car</a></li>
            <li><hr class="dropdown-divider"></li>
          </ul>
        </li>
      </ul>
